...
return {
    {
        ...
        init = function()
            ...
            map("n", ",c", "<cmd> Telescope codecompanion<CR>")
            map("v", ",c", "<cmd> Telescope codecompanion<CR>")
            map("n", ",g", "<cmd> Telescope my_git_commits<CR>")
        ...
        config = function()
            ...
            require("telescope").setup({
                ...
                pickers = {
                    find_files = {
                        find_command = { "rg", "--files", "--iglob", "!.direnv", "--iglob", "!.git", "--iglob", "!target/debug", "--hidden" },
                        hidden = true,
                    },
                    buffers = {
