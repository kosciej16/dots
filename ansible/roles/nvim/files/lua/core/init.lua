...
map('n', '<leader>fl', ':let @+ = join([expand("%"),  line(".")], ":")<CR>')
-- as import -  .config.nvim.vimrc_parts.mappings
map('n', '<leader>fi', ':let @+ = substitute(expand("%:r"), "/", ".", "g")<CR>')
-- content
map('n', '<leader>fc', ':%y+<CR>')
